...
import certificationAuthoritiesEn from '../view/CertificationAuthorities/translations/en.certificationAuthorities.i18n.json';
import certificationAuthoritiesPtBr from '../view/CertificationAuthorities/translations/pt_br.certificationAuthorities.i18n.json';
...
import createCertificationAuthorityEn from '../view/createCertificationAuthority/translations/en.createCertificationAuthority.json';
import createCertificationAuthorityPtBr from '../view/createCertificationAuthority/translations/pt_br.createCertificationAuthority.json';
import errorEn from './translations/en.error.i18n.json';
import errorPtBr from './translations/pt_br.error.i18n.json';
import importCertificatesEn from '../view/importCertificates/translations/en.importCertificates.i18n.json';
import importCertificatesPtBr from '../view/importCertificates/translations/pt_br.importCertifricates.i18n.json';
...
const resources = {
  en: {
    ...
    importCertificates: importCertificatesEn,
  ...
  'pt-BR': {
    ...
    importCertificates: importCertificatesPtBr,
    error: errorPtBr,
    success: successPtBr,
...
securityInstance.use(initReactI18next).init({
  ns: [
    'common',
