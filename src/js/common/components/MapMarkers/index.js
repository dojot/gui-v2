...
import lightBlueFilledMarker from 'Assets/images/markers/light-blue-pin.png';
import lightGreenFilledMarker from 'Assets/images/markers/light-green-pin.png';
import lightPinkFilledMarker from 'Assets/images/markers/light-pink-pin.png';
import lightPurpleFilledMarker from 'Assets/images/markers/light-purple-pin.png';
import lightRedFilledMarker from 'Assets/images/markers/light-red-pin.png';
import lighterBlueFilledMarker from 'Assets/images/markers/lighter-blue-pin.png';
...
export const lightPurpleMarker = getMarker(lightPurpleFilledMarker);
export const lighterBlueMarker = getMarker(lighterBlueFilledMarker);
export const lightRedMarker = getMarker(lightRedFilledMarker);
export const lightPinkMarker = getMarker(lightPinkFilledMarker);
...
export const getMarkerColor = color => {
  switch (color) {
    ...
    case '#c4def6':
      return lighterBlueMarker;
    case '#bed3f3':
      return lightBlueMarker;
    case '#d4c4fb':
      return lightPurpleMarker;
    default:
      return blackMarker;
  }
};
