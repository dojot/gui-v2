...
const MassActions = ({
  ...
  handleFavoriteMultipleCertificates,
}) => {
      ...
      <Grid container spacing={2} alignItems='center'>
        ...
        <Grid item xs='auto'>
          <Button
            ...
            onClick={handleFavoriteMultipleCertificates}
            startIcon={<Star />}
            variant='contained'
          >
            {t('favorite')}
...
MassActions.propTypes = {
  ...
  handleFavoriteMultipleCertificates: PropTypes.func,
};
...
MassActions.defaultProps = {
  ...
  handleFavoriteMultipleCertificates: null,
};
